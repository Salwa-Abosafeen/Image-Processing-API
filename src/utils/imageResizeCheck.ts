...
export const checkIfImageFullExists = async (req: Request, res: Response, next: NextFunction) => {
    ...
    let check = await fs.existsSync(`./public/images/full/${filename}.jpg`)
...
export const checkIfImageThumbnailExists = async (req: Request, res: Response, next: NextFunction) => {
    ...
    let check = await fs.existsSync(`./public/images/thumbnail/${filename}-${width}-${height}.jpg`)
