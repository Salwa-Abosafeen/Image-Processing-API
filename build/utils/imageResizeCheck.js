...
var checkIfImageFullExists = function (req, res, next) {
      ...
      switch (_a.label) {
        case 0:
          ...
          if (!filename) {
            return [
              2 /*return*/,
              res.status(403).json({ message: 'Missing filename' }),
            ];
          }
          return [
            4 /*yield*/,
            fs_1.default.existsSync(
              './public/images/full/'.concat(filename, '.jpg')
            ),
          ];
        case 1:
          check = _a.sent();
...
var checkIfImageThumbnailExists = function (req, res, next) {
  return __awaiter(void 0, void 0, void 0, function () {
      ...
      switch (_a.label) {
        case 0:
          ...
          if (!width || !height) {
            return [
              2 /*return*/,
              res.status(403).json({ message: 'Missing width or height Data' }),
            ];
          }
          return [
            4 /*yield*/,
